...
count_tab <- read.table("/Users/gordoncuster/Desktop/untitled folder/otutable_esv.txt", header=T, row.names=1, check.names=F)
...
tax_tab <- as.matrix(read.table("/Users/gordoncuster/Desktop/untitled folder/Herb1_Taxonomy.txt", header=F, row.names=1, check.names=F, na.strings="", sep="\t"))
#This is your metadata. 
sample_info_tab <- read.csv("/Users/gordoncuster/Desktop/untitled folder/Herb_Pt_1_IC_anion_cation_import_to_R.csv", header=T)
...
#check correlations of technical replicates. I'm choosing to sum below, but it would be good to know this information. 
#to be added. 
...
library(phyloseq)
your_phyloseq_object<-phyloseq(otu_tab, samp_dat, tax_tab)
