...
tax_bac <- data.frame(tax_table(phyloseqD))
...
taxa_and_reg_results<-cbind(regressionresults, tax_bac)



write.csv(taxa_and_reg_results, "/Users/gordoncuster/Desktop/Git_Projects/Herbicide_Microbes_PT1/data/PhyloseqObjects/16S/Regressionresults16S.csv")
