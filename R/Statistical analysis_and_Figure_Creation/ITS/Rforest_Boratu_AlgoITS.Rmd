...
micrUBIfuns::plot_taxa_heatmap(merged_baruta_simper_time, rm_na = F, tax_rank = "Family",scale_by = "taxa", cluster_rows=F, cluster_columns = T, show_column_names = T, column_names_side = "bottom",, column_names_rot = 80, )
...
micrUBIfuns::plot_taxa_heatmap(merged_baruta_simper_time, rm_na = F,scale_by = "taxa", cluster_rows=F, cluster_columns = T , column_labels = tax_table(merged_baruta_simper_time)[,3], row_dend_reorder = TRUE, column_order = sort(fam_names[,1]))
```
