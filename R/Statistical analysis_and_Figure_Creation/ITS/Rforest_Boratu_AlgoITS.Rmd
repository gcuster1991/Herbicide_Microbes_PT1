...
micrUBIfuns::plot_taxa_heatmap(merged_baruta_simper_time, rm_na = F,scale_by = "taxa", cluster_rows=F, cluster_columns = T ,column_labels = tax_table(merged_baruta_simper_time)[,3], row_dend_reorder = TRUE)
