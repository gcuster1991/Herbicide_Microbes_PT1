...
levels(sample_data(ps_rare)$Mode) <- c(Clarity  = "Chemical", Aatrex = "Chemical", `Roundup Powermax` = "Chemical", `Non-Treated` = "Non-Treated", Hand = "Hand")
...
test<-abund_aov_wrangle(ps_rare_order_top10, y = "Order")
