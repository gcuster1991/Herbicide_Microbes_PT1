...
ord_t3_rare<-ordinate(physeq = subset_samples(ps_rare_sub, Time=="T3"), method = "NMDS", distance = "bray", k=3, trymax= 100)
T3_rare<-ggordiplots::gg_ordiplot(ord = ord_t3_rare, groups = data.frame(sample_data(subset_samples(ps_rare_sub, Time == "T3")))$Herbicide, choices = c(1, 2), kind = c("se"), conf = 0.95, show.groups = "all", ellipse = TRUE, label = FALSE, hull = FALSE, spiders = FALSE, plot = TRUE, pt.size = 1)
...
ps_betadispr(subset_samples(ps_rare_sub, Herbicide == "Roundup Powermax"), groupingvar = "Time")
ps_betadispr(subset_samples(ps_rare_sub, Herbicide == "Aatrex"), groupingvar = "Time")
ps_betadispr(subset_samples(ps_rare_sub, Herbicide == "Clarity"), groupingvar = "Time")
ps_betadispr(subset_samples(ps_rare_sub, Herbicide == "Hand"), groupingvar = "Time")
...
beta_anova(beta_div_T1_T2_T3, Herbicide = "Hand")
beta_anova(beta_div_T1_T2_T3, Herbicide = "Clarity")
beta_anova(beta_div_T1_T2_T3, Herbicide = "Aatrex")
beta_anova(beta_div_T1_T2_T3, Herbicide = "Roundup Powermax")
...
ggarrange(T1_beta_chemical_combined$plot, T2_beta_chemical_combined$plot, T3_beta_chemical_combined$plot, ncol = 1)
ggsave("/Users/gordoncuster/Desktop/Git_Projects/Herbicide_Microbes_PT1/Figures/ITS_combined_rare_within_group_beta_chemical_combined.pdf", width = 7, height = 10)
