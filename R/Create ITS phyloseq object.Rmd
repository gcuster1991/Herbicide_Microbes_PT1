...
count_tab <- read.table("/Users/gordoncuster/Desktop/Manuscript Submissions/Herbicide and Microbes/Sequence_data/ITS/otutable_esv.txt", header=T, row.names=1, check.names=F)
...
tax_tab <- as.matrix(read.table("/Users/gordoncuster/Desktop/Manuscript Submissions/Herbicide and Microbes/Sequence_data/ITS/OTU_sintax.txt", header=F, row.names=1, check.names=F, na.strings="", sep="\t"))
...
count_tab2<-count_tab2[,!colSums(count_tab2)<=300]
